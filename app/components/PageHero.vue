    ...
    <div class="relative w-full h-screen flex items-center justify-center p-4" ref="heroSection">
        <div class="flex flex-col md:flex-row items-center justify-center gap-12 lg:gap-20 max-w-6xl mx-auto w-full">
            <div class="md:w-1/2 flex flex-col items-center md:items-start text-center md:text-left gap-8">
                ...
                <div class="relative flex flex-wrap justify-center md:justify-start items-center gap-[1em]"
                    ref="containerRef">
...
const activeWordIndex = computed(
    () => animatedIndexes[currentAnimatedIndex.value],
);
...
const initializeAnimationState = () => {
    ...
    gsap.set(
        [titleRef.value, cardRef.value, containerRef.value, arrowRef.value],
        {
            opacity: 0,
            y: 30,
        },
...
watch(activeWordIndex, async (newActiveIndex) => {
    ...
    interval = window.setInterval(
        () => {
            currentAnimatedIndex.value =
                (currentAnimatedIndex.value + 1) % animatedIndexes.length;
        },
