<template>
  <footer class="bg-white dark:bg-black border-t border-gray-200 dark:border-white/10 pt-12 pb-8">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">

      <div class="flex flex-col md:flex-row justify-between items-center gap-6 mb-8">
        <div class="text-center md:text-left">
          <h3 class="text-2xl font-bold text-gray-900 dark:text-white tracking-tight">
            Dzaky<span class="text-gray-400 dark:text-gray-600">.</span>
          </h3>
        ...
        <div class="flex space-x-6">
          <a href="#" aria-label="GitHub"
            class="text-gray-400 hover:text-black dark:hover:text-white transition-colors duration-300">
      ...
      <div class="w-full h-px bg-gray-100 dark:bg-white/5 mb-8"></div>

      <div class="flex justify-center items-center">
        <div class="text-xs text-gray-400 dark:text-gray-600">
          &copy; {{ currentYear }} Dzaky Rahmat Nurwahid. All rights reserved.
        </div>
      </div>
