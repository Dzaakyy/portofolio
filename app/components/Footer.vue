  ...
  <footer class="bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-center space-x-6 mb-6">
        <a 
          href="#" 
          class="text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white transition-colors duration-300 transform hover:scale-110"
          aria-label="GitHub"
        >
      ...
      <div class="text-center">
        <div class="text-gray-600 dark:text-gray-400 text-sm">
          Dzaky Rahmat Nurwahid &copy; {{ currentYear }}
        </div>
      </div>
    </div>
  </footer>
